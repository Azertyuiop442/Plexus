...
| **v0.1.5** | *Shipped* | Cross-Platform Sound Alerts & Notifications, Audio Preview Modal, Task Completion & Blocked State Triggers |
| **v0.1.6** | *Current Release* | In-Dashboard Skills Manager, Live Session Freshness Marks, Bridge & Prefs Hardening |
